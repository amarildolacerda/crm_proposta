                                ...
                                <table class="table table-bordered table-hover table-striped table-condensed">
                                    ...
                                    <tbody>
                                        <?php foreach ($results as $r) { ?>
                                            <tr> 
                                                <td class="text-middle ng-binding"><?php echo $r->idcrm; ?></td>
                                                <td class="text-middle ng-binding"><?php echo $r->empresa; ?></td> 
                                                ...
                                                <td class="text-center">
                                                    <a title="visualizar" href="<?php echo base_url() ?>index.php/crm/view/<?php echo $r->idcrm; ?>" class="btn btn-success btn-xs"><i class="fa-fw glyphicon glyphicon-eye-open"></i> </a>
